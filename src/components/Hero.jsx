    ...
    return (
        <div>
            <div className='my-5 relative'>
                <img className='w-full h-96 bg-center bg-cover object-cover' src="https://static.tacdn.com/img2/brand/home/homemar2022_dt_trans@2x.webp" alt="" />
                ...
                <div className='flex flex-col z-10 text-white items-center justify-center text-center space-y-2'>
                        ...
                        <p className='text-base md:text-xl font-semibold text-gray-100'> Want someone to share the journey with? </p>
